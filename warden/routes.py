...
from warden.warden import (list_specter_wallets, warden_metadata, positions,
                           ...
                           generatenav, specter_df, current_user,
                           check_services, current_path)
...
def node_info():
    ...
    from mynode import (get_service_status_code, get_bitcoin_blockchain_info,
                        ...
                        get_mynode_block_height, get_service_status_color,
    ...
    if status['bitcoind_status_code'] != 0:
        ...
        if is_specter_enabled():
            status['specter_status_color'] = get_service_status_color(
                "specter")
...
def portstats():
    ...
    meta["end_portvalue_usd"] = meta["end_portvalue"] / FX_RATE
