...
def find_usable_port(port, app):
    ports = [5001, 5002, 5003, 5004, 5005, 5006, 5007, 5008, 5009, 5010]
    # First check the provided port number
    if is_port_in_use(port) is True:
        # Port in use... Let's try other ports...
        print(
            warning(
                f"[!] Provided port {str(port)} is in use. Will try other ports..."
            ))
